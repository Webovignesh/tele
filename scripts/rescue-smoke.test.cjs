...
assert.match(dailyDriverV3, /IntersectionObserver/, 'v3 media thumbnails implementation must remain available for isolation work')
assert.match(dailyDriverV3, /XMLHttpRequest/, 'v3 attachment upload implementation must remain available for isolation work')
assert.match(dailyDriverV3, /teleV3OpenPreview/, 'v3 resilient preview implementation must remain available for isolation work')
assert.match(dailyDriverV3, /teleV3UnionSelectionKeys/, 'v3 selection implementation must remain available for isolation work')
assert.match(dailyDriverV3, /scan-media-v3/, 'v3 chat-scoped index implementation must remain available for isolation work')
assert.match(dailyDriverV3Css, /position:\s*relative\s*!important/, 'v3 selection dock stylesheet must remain available for isolation work')
